    ...
    def baseDataRDD(rdd: RDD[ConsumerRecord[String, String]]) = {
        rdd
          ...
          .map(obj => {
              ...
              (day, hour, List[Double](1, succAndFeeAndTime._1, succAndFeeAndTime._2, succAndFeeAndTime._3), pcode, minute)
          }).cache()
    }
